...
if /i "%VERSION_CHOICE%"=="y" (
    ...
    for /f "delims=" %%A in ('powershell -Command "(Invoke-WebRequest -Uri 'https://api.github.com/repos/MRHP1/DS4Windows/releases/latest' -Headers @{ 'User-Agent' = 'Mozilla/5.0' }).Content | ConvertFrom-Json | Select-Object -ExpandProperty tag_name"') do (
...
set BASE_URL=https://github.com/MRHP1/DS4Windows/releases/download
